...
There is an widget model for each basic UI widget \ben{now only list, text and button} with their entry points for each customizable behavior of the widget and exit point for information you want to retrieve.  \ben{not yet full coverage}
