...
You can also copy and rename files using the methods \ct{copyTo:} and \ct{renameTo:}. Note that while copyTo: expect another fileReference, renameTo: expects a string.
