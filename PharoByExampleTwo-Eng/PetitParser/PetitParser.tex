...
In \figref{pp/browser} you can see window of \clsind{PPBrowser}. 
The left panel called Parsers contains list of all parsers in the system.
You can see our \clsind{ExpressionGrammar} and its subclasses as well as \clsind{PPJsonGrammar} we defined earlier in this chapter.
...
\begin{description}
	...
	\item [Debugger] shows tree view of steps that were performed during parsing.
		...
		For example, you can inspect how does the \clsind{PPJsonGrammar} work, what rules and in which order are called as is depicted in \figref{pp/debugger}.
