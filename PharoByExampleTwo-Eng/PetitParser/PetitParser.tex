...
To define our \ct{PPJsonGrammar}, we first need to create a class:
...
We will use the \ct{CharacterTable} class variable later to parse
strings.
...
\end{jsonscript}
\dc{some parts of previous script are in italic, no idea why}
% $ <-- to cancel previous one for Emacs highlighting

Special characters allowed after a slash and their meanings are
defined in the \ct{CharacterTable} dictionary:
