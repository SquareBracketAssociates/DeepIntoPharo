...
protocols of \ct{PPParser}. If you want to know more about these
...
The \ct{trim} call allows the parser to accept spaces before and after
the number such as in \ct{' 123 '}. The action block asks the parser
...
productions as \ct{PPDelegateParser} upfront, because they recursively
