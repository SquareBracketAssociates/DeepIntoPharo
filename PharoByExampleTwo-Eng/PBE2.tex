...
% TODO Lulu
%%%%%%%
%La derniere page du livre doit etre completement vierge.
% completer le copyright
%%%%
%for the cover:
%%%%
%Le titre et le nom de l'auteur doivent figurer sur la couverture 
 %Gardez tous les textes importants et images a au moins 0,95 cm ou 0,375" (soit 0,63 cm ou 0.25" de d?bord + 0,32 cm ou 0.125" de securite) de chaque cote de la couverture (y compris la tranche du dos). Cette zone peut etre coupee ou marquee par les replis de la couverture.
 %Le texte de la tranche du dos doit etre a au moins 0,2 cm (0.0625") de chaque cote de la tranche du dos.
...
%La couverture doit avoir un numero ISBN/EAN correct a 13 chiffres.
...
\input{Biographies/Biographies.tex}
%FINISHED
