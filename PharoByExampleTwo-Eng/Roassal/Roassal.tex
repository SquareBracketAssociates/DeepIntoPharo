...
It creates and opens a visualization with a single element of a squared size of 100 pixel. However, by executing this code nothing appears in the visualization. The element has effectively been added to the view, but we have not told the element how it should be rendered. 
...
Instead, we provide \emph{iterations}, \alex{@@HERE}
