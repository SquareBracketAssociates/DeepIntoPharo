...
\mmp{yes, I wouldn't show it...too much internal detail..}
...
You can also use the Metacello Toolbox API (not finished/tested yet):
...
ConfigurationOfCoolToolSet>>baseline06: spec 						!\emph{"could be called differently just a convention"}!
       ...
       <version: '0.6-baseline'> 						                        !\emph{"could be called differently just a convention. This pragma is used for the version: method"}!
