...
\mmp{ I didn't understand. Using versionString: from the baseline or using project:with: from a version. }
...
\mmp{but at the same time, for the packages, you use with: so in such case at least it is uniform. Otherwise, change also for packages.}
...
\mmp{I have already asked this one year ago. You can read the answer here: http://forum.world.st/I-think-file-is-quite-confusing-td1471992.html}
