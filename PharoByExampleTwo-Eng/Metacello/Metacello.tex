...
\mmp{We should put a link or somewhere say that there is a whole chapter about Monticello} 
...
\mmp{are you sure there is a chapter of Gofer? As long as I know there is a chapter of Monticello, but not Gofer. All I know about Gofer is http://www.lukas-renggli.ch/blog/gofer}
...
\mmp{Stef, I have included in the diagram, in version05 and version06, the version of ProjectB}
...
\mmp{be careful because right now, this piece of code is split between to pages and the figure 1.5 in the middle. It is ugly!!!  we cannot do that.}
...
\mmp{hahahahha you couldn't express in the diagram that CoolBrowser-AddonsTests also depends on CoolBrowser-Tests hahah :) }
...
\mmp{notice that it is the first time you include \#bleessing for a version method. And you don't explain what \#development is. Are you sure it was on purpose? I vote for removing the blessing from this example}
...
will load all the packages. Moreoever, by default, 'default' loads 'ALL'!
