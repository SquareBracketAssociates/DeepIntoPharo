...
\ja{i cannot load this code in PharoCore 2.0. We need a stable version}\ja{I am not sure that we must have loadDefault. We need a fixed version, like that, the source code will work in 3 years.}\ab{We will check this before publishing the book}
\begin{code}{}
Gofer new
...
as well as directory entry sorting \vu{which sorting?}, access permission handling and
...
\caption{Code editor sporting a Mondrian \ja{is it still available ?} presentation in addition to a simple class list.}
