...
\item \ct{stackp} defines the number of stored temporary variables. This includes messages arguments, therefore in the example it should be two (one for \ct{temp} and one for \ct{arg})
