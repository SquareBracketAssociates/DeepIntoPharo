...
% explain first everything with custom block- and method-contexts
% then section about VM stack mapping
% then explanation of the temp vector with examples
% then read temp optimization
% temp at put indirection
