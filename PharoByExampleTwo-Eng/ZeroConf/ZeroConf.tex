...
The option \ct{-O -} will output the downloaded bash file to standard out, so we can pipe it to \ct{bash}. If you do not like the log of web, use \ct{--quiet}.
...
Last tuesday I presented the new zeroconf scripts for Pharo at the pharoconf in Bern.
...
Deprecation:
============
I will manually mark the existing scripts as deprecated by tomorrow and leave them
...
This will most probably be the final stage of the zeroconf scripts as I don't see
