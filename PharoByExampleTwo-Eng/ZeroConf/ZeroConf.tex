...
First here is a way to download a zero configuration script that downloads the latest 2.0 Pharo image and vm. 
...
To execute the script you should change its  permissions using \ct{chmod a+x}  or invoke it via bash as follows. Here we just want to have a look at the help of the script.
