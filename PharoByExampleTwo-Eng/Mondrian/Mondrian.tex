...
In the example, we used \ct{sortedAs:} to order the nodes representing methods. This method is defined on Collection and belongs to Mondrian \ja{why it belongs to mondrian ?}\alex{I am checking whether this method could be move directly to Pharo}. To see example usages of \ct{sortedAs:}, browse its corresponding unit test:
\begin{code}{}
