...
By action-clicking on a package, you can select the item \button{History}. It opens a version history viewer that displays the comments committed along with each version of the selected package (see \figref{historyviewer}).  
...
\begin{figure}[ht]\centering
	...
	\caption{Repositories under SmalltalkHub are highly configurable.\figlabel{squeaksourcesetting}}
\end{figure}
