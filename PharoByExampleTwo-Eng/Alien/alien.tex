...
callouts: \sd{what are we describing? the method body or the ... NBFFICallout cdecl:  module: NativeBoost CLibrary}
...
\item [Pragma declaration.] The Smalltalk code that describes the C header and `binds' Smalltalk arguments to C arguments. In this case it was: \sd{is it the pragma primitive: primitiveNativeCall module: }
...
We want to call the very well known \ct{strlen} function. This function requires a string as argument and returns its number of characters. 
...
argument \ct{(char* aString)}. This type-and-name pair will be repeated, separated 
