...
\end{enumerate}
\sd{add a picture about the different thread and sockets}
...
\sd{would be good to have a picture explaining socket stream and more importantly a API description of the most important methods}
