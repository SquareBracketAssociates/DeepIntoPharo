...
When \ct{aBlock value} contains an exception or a non-local return, since the complete variable will be already true, there is no need to execute again the block.
