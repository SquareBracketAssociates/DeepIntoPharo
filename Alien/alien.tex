...
\subsection{Analysis}
\sd{I will refactor that text}
What we have just done is usually called an FFI callout. \ct{NBFFICallout} is the class that represents this behavior, which is essentially a call to an external function.
We use the  message \ct{#cdecl:module:} to describe this call. 
