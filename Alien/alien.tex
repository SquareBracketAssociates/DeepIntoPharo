...
This function is part of the standard C library. Its C declaration is\luc{according to man it is: clock\_t clock(void) , I suppose clock\_t end up in an int?}:
