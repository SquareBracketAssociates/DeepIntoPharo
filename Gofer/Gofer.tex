...
a password is not really adequate. Here is an example for smalltalkHub (which has some verbose urls such as 
 \url{'http://smalltalkhub.com/mc/PharoBooks/GoferExample/main'} for the project GoferExample). We use the \ct{smalltalkhubUser:project:} message and just specify the minimal information. In this chapter, we also use \ct{squeaksource3:} as a shortcut for \url{http://ss3.gemstone.com/ss}.
...
\item The API provides some useful shortcut: \ct{smalltalkhubUser:project:} is a shortcut for \ct{http://www.smalltalkhub.com}, \ct{squeaksource3:} for \ct{http://ss3.gemstone.com/ss/} and \ct{gemsource:} for \ct{http://seaside.gemstone.com/ss/}.
