...
The message \mthind{BlockClosure}{once} is another extension that caches the results and interned it until the receiver is uncached. A typical usage is the following one:
