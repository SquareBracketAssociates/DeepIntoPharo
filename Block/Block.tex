...
Here are some examples of \ct{cull:} and  valueWithPossibleArgs: usages.
...
The message \ct{once} is another extension that caches the results and interned it until the receiver is uncached.
