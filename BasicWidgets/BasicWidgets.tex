...
Graphical animations, simulations and other processes that need to be able to update the user interface continuously and frequently can make use of the stepping system on their model. To participate, your model must implement \mthind{Model}{wantsStepIn: aSystemWindow} to indicate that you want stepping and \mthind{Model}{stepTimeIn: aMillisecondTimeStamp} to indicate how frequently you want them. For example:
