...
\subsection{Debugging example}
  ...
  The \clsind{BacktrackingParser} does too much backtracking.
...
We may try to update \clsind{BacktrackingParser} so that the '\ct{a*c}' strings are parsed in a similar way as the '\ct{a*b}' strings.
...
This is very good improvement compared to the 110 invocations of the parser \ct{b} and 55 invocations of the parser \ct{a} in the original version of \clsind{BacktrackingParser} (see \figref{pp/example-tallyAaac}).
