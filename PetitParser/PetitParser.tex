...
\dc{revoir les fleches dessus/dessous}

The syntax diagrams for JSON objects and arrays are in
Figures~\syntaxjsonref{object} and~\syntaxjsonref{array}.
...
with double-quotes. What is inside these double-quotes is either an
escape character, an octal character, or a normal character.
...
\begin{figure}
  ...
  \caption{Syntax diagram representation for the number parser defined in \scrref{number}}
...
% LocalWords:  subclassing PetitParser JSON Wikipedia hexa
