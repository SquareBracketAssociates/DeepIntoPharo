...
What the help mentions is that the script will download the current vm and put it into the pharo-vm folder, \ct{pharo} a script to launch the system, \ct{pharo-ui} a script to launch the image in ui mode.
...
If you do not like the log of web, use \ct{--quiet}.
