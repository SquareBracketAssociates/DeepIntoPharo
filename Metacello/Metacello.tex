...
Let us explain this using Figure~\ref{configurations}. ConfigurationOfProjectA contains several baselines (here two baselines 0.4 and 0.5) and versions (here 0.4, 0.41, 0.5, and 0.6). Baseline 0.4 defines that it is composed of two packages. Baseline 0.5 is composed of 3 packages and it depends on Project B. A version describes specific package versions. A version may also refine another one. All these points are explained in detail after. 
