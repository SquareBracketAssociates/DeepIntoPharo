...
Concerning the value of the preference itself, if you inspect \ct{RealEstateAgent usedStrategy}, you should notice that the result is a value among \ct{\#staggerFor:initialExtent:world:},  \ct{\#cascadeFor:initialExtent:world:} and \ct{\#standardFor:initialExtent:world:}. In fact, the values of the Associations are used to compute all possible real values for the setting.
